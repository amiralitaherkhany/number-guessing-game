...
const (
	...
	correctGuessMessage          = "Congratulations! You guessed the correct number in %d attempts in %s.\n"
...
func ShowWin(attempts uint8, elapsedTime string) {
	fmt.Printf(correctGuessMessage, attempts, elapsedTime)
}
